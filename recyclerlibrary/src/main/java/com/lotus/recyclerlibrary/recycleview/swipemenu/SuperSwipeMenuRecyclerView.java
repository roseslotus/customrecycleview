package com.lotus.recyclerlibrary.recycleview.swipemenu;
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action & MotionEventCompat.ACTION_MASK) {
            case MotionEvent.ACTION_DOWN:
                ...
                mTouchView = (SuperSwipeMenuLayout) view.findViewWithTag("SuperSwipeMenuLayout");
